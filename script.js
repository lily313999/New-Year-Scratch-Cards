...
const nicknameRewards = {
  "吟遊": ["img/img01.png"],
  "一隻刺": ["img/img1106.png","img/img11068.png","img/img11069.png","img/img110610.png","img/img110611.png"],
  "家和": ["img/common31.png"],
  "睏睏": ["img/common30.png"],
  "奶茶": ["img/img04.png"],
  "穎秀": ["img/img12342.png"],
...
for (let i = 1; i <= 43; i++) cardPool.common.push(`img/common${i}.png`);
for (let i = 1; i <= 12; i++) cardPool.rare.push(`img/rare${i}.png`);
